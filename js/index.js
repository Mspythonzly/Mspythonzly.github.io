$(function(){
    ...
    var musicNameData = ['出山','有时候新鲜感才是好东西','地4'];                   // 歌曲名数组
    var artistNameData = ['花粥/王胜娚','花粥/马雨阳','作者未知']            // 创作歌手数组
    var musicUrls=['music/music1.mp3','music/music4.mp3','music/music5.mp3'];// 歌曲mp3数组
